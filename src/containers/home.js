    ...
    return (
      <div className="home"> 
        ...
        <div class="information__content1">
             ...
             <div class="information__content1__box">
        ...
        <div class="information__content2__box">
        ...
        <div class="news">
        <h1 class="news__header">iPLACE ข่าวสารและกิจกรรม</h1>
        <a className="btn  btn--animated news__button">อ่านข่าวทั้งหมด</a>
        <p className="news__no-news heading-4">No news at this time.</p>
        </div>
